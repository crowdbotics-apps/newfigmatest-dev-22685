...
## Project Structure
    ...
    ├── newfigmatest_dev_22685  # Django project configurations
...
1. Clone this repo and `cd newfigmatest_dev_22685`
...
2. Clone this repo and `cd newfigmatest_dev_22685`
